...
class TestResponses(object):
    ...
    def test_get_successful(self):
        ...
        """
        scraper = Scrapy()
        with vcr.use_cassette(os.path.join(CASSET_DIR, 'bad_actor_get1.yaml')):
    ...
    def test_get_user_agent(self):
        ...
        with vcr.use_cassette(os.path.join(CASSET_DIR, 'bad_actor_get2.yaml')):
            response = scraper.get('http://www.bad-actor.services/api/symbols/1')
            assert response.status_code == 200
